                            ...
                            <div className="relative">
                                <DoubleButton
                                    ...
                                    onClick={() => {
                                        ...
                                        window.open(Config.userInfo.resumes["EN"], "_blank");
                                    }}
                                    onIconClick={() => {
                                        Tracker.onButtonClick("Download Resume");

                                        var link = document.createElement("a");
                                        link.download = `Resume_${Config.userInfo.fullName.replaceAll(" ", "_")}_default.pdf`;
                                        link.href = Config.userInfo.resumes["EN"];
                                        link.click();
                                        link.remove();
                                    }}
                                />
